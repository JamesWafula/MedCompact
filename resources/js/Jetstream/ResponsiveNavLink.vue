...
const classes = computed(() => {
    return props.active
        ? "block pl-3 pr-4 py-2 border-l-4 border-primary text-base font-medium text-primary focus:outline-none focus:text-primary focus:border-primary transition"
